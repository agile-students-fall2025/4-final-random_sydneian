...
Refer to the [setup guide in the README](README.md#local-setup-guide).
...
1. Double check your code works well, doesn't have bugs, and is cleanly and properly implemented.
1. Ensure it's formatted and linted:
   ```bash
   $ npm run fix-format-lint
   ```
1. Run the [tests](README.md#how-to-test).
1. Push your work.
   ```bash
...
1. Congrats, and thank you for your contributions!

...
function BucketList() {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      <div className="px-4 pb-3 border-b border-black">
        <div className="flex rounded-md overflow-hidden border border-black">
          ...
          <button
            ...
            className={`flex-1 py-2 px-4 text-sm font-medium border-l border-black ${
              activeTab === 'done'
                ? 'bg-black text-white'
                : 'bg-white text-black'
            }`}
      ...
      <button className="fixed bottom-20 right-4 w-14 h-14 bg-black rounded-full flex items-center justify-center shadow-lg hover:bg-gray-800 transition-colors">
